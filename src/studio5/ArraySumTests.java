...
public class ArraySumTests {
    ...
    public void testSumOfOneItem() {
       ...
       Methods.arraySum(testArray));  // The thing to test
    }
    ...
    public void testSumOfFiveItems() {
        ...
        assertEquals(5, Methods.arraySum(testArray));
    }
    ...
    public void testSumOfEmptyArray() {
        int[] testArray = {};
        assertEquals(0, Methods.arraySum(testArray));
    }
    ...
    public void testSumOfTwelveFives() {
        ...
        assertEquals(60, Methods.arraySum(testArray));
    }
}
