 ...
 */
@RunWith(Suite.class)
@Suite.SuiteClasses({ DistanceBetweenTest.class, ArraySumTestSuite.class, FilledArrayTestSuite.class,
		ArrayMeanTestSuite.class, FilledArraySumAndMeanComprehensiveTest.class })
